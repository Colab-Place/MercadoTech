...
describe("find and populate tests", () => {
  it("finds documents", () => {
    helper.findPopulateNestedSortAndLimit(
      "payment", {}, { path: "card", select: "num" }, { date: -1 }, 0, 1)
  ...
  it("populates fields", () => {
    ...
    helper.findPopulateNestedSortAndLimit(
      "payment", {}, populateQuery, { date: -1 }, 0, 1)
  ...
  it("sorts de resuts", () => {
    helper.findPopulateNestedSortAndLimit(
      "payment", {}, { path: "card", select: "num" }, { date: -1 }, 0, 2)
  ...
  it("returns the expected length", () => {
    ...
    helper.findPopulateNestedSortAndLimit(
      "payment", {}, { path: "card", select: "num" }, { date: -1 }, 0, limit)
