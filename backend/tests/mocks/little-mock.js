...
async function createMock () {
  ...
  const promises = [
    helper.insertNewDocument("payment", { amount: 4000, state: paymentStatus, card, date: new Date(2001, 2, 16) }),
    helper.insertNewDocument("payment", { amount: 5000, state: paymentStatus, card, date: new Date(2001, 2, 16) }),
    helper.insertNewDocument("payment", { amount: 6000, state: paymentStatus, card, date: new Date(2001, 2, 16) })
